      ...
      <div className="hand-container" style={{ flexWrap: 'wrap', justifyContent: 'center', textAlign: 'center', marginTop: '64px' }}>
        {
          mouseList.filter(mouse => mouse.size === location.state.ukuranTangan)
            ...
            .map(mouse =>
              <div key={mouse.key} style={mouseListStyle} className="mouseListStyle">
                <a style={{ color: 'white', textDecorationColor: 'grey', textDecoration: 'none', }} target="_blank" href={`https://www.tokopedia.com/search?st=product&q=${mouse.mouseName}&navsource=home`}>
                  {mouse.mouseName}
                </a>
              </div>)
        }
